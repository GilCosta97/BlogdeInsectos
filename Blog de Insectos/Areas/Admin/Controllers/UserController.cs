...
namespace Blog_de_Insectos.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordVM vm)
        {
            ...
            if (result.Succeeded)
            {
                _notification.Success("Password reset successfull!");
        ...
        public async Task<IActionResult> Register(RegisterVM vm)
        {
            ...
            {
                _notification.Error("Email already exists, please use a valid email.");
                return View(vm);
            }
            var checkUserByUserName = await _userManager.FindByNameAsync(vm.UserName!);
            if (checkUserByUserName != null)
            {
                _notification.Error("Username already in use, please choose a valid Username.");
                return View(vm);
            }
        ...
        public async Task<IActionResult> Login(LoginVM vm)
        {
            ...
            if (!verifyPassword)
            {
                _notification.Error("Password is incorrect");
                return View(vm);
            }
